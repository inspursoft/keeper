...
def release(action):
  ...
  try:
    ...
    if action == "create":
      ...
      history_file_path = "history/release-{}.md".format(version_info,)
      KeeperManager.manipulate_file_to_repository(action, project_id, release_branch, operator, email, history_file_path, md_content, current_app)
